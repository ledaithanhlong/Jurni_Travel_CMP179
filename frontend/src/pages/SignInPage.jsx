      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Hoặc{' '}
            <Link to="/sign-up" className="font-medium text-orange-accent hover:text-orange-hover transition">
              tạo tài khoản mới
            </Link>
          </p>
        </div>
          ...
          <div className="rounded-lg shadow-lg bg-white p-8 space-y-6">
            ...
            <div>
              <button
                ...
                className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-dark hover:bg-blue-dark/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-dark disabled:opacity-50 disabled:cursor-not-allowed transition shadow-md"
              >
                {loading ? (
